  ...
  <section class="mx-auto flex min-h-svh w-full max-w-[1440px] flex-col border border-text" aria-labelledby="page-title">
    ...
    <footer class="flex items-center justify-between border-t border-text px-6 py-5 text-[15px] font-bold uppercase tracking-[0.18em] text-subtle min-[760px]:px-12 min-[1120px]:px-[90px]">
      ...
      <div class="flex items-center gap-2">
        <button
          type="button"
          class="focus-ring inline-grid h-9 w-9 cursor-pointer place-items-center border-0 bg-transparent p-0 text-accent transition-colors duration-[180ms] hover:text-accent-strong"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          class="focus-ring inline-grid h-9 w-9 place-items-center text-accent no-underline hover:text-accent-strong"
          aria-label="GitHub"
          title="GitHub"
        >
          <svg class="h-5 w-5" viewBox="0 0 19 19" fill="currentColor" aria-hidden="true">
            <path
              fill-rule="evenodd"
